...
public class Controller implements Initializable {
	...
	Button btn_play;
	@FXML
	TextField area_filePath;
	@FXML
	TextField occultChar;
	@FXML
	Text txt_wordCount;
	@FXML
	TextArea field_transcription;

	@FXML
	ImageView mp3_picture;
	@FXML
	...
	@FXML
	RadioButton trainningModeRadioButton;
	@FXML
	RadioButton evaluationModeRadioButton;

	@FXML
	CheckBox enableIncompleteWord;
	@FXML
	CheckBox enableDisplayNbWordFound;
	@FXML
	CheckBox enableAnswerDisplay;

	@FXML
	RadioButton twoLettersMinRadioButton;
	@FXML
	RadioButton threeLettersMinRadioButton;
	...
	@FXML
	public void dispose() { // Ne corrige pas le problème que l'on a lorseque l'on charge un média plusieurs
							// fois, donc ne sert pour l'instant à rien
		mediaPlayer.stop();
		mediaPlayer.dispose();
	}
