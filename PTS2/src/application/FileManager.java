...
public class FileManager {
	...
	public void sauvegarderFichier(String exoName, String path, String consigne, String script, String aide,
		...
		// Ecriture de la vid�o dans un fichier tampon
		...
		foutF.write(0x00);//�a c'est traitre
		while (finF.available() != 0) { // Ecriture de la vid�o depuis le fichier tampon
...
//			System.out.println("Fichier �crit sans probl�me : ");
