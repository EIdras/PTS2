...
public class SaveFileController extends ParentController implements Initializable{
	...
	/* consigne 	: Cha�ne de caract�res qui correspond � la consigne saisie
	 * script 		: Cha�ne de caract�res qui correspond au script du m�dia
	 * aide 		: Cha�ne de caract�res qui correspond � l'aide saisie
	 * media		: Chemin vers le fichier audio ou vid�o charg� par l'enseignant
	 * occult		: Caract�re d'occultation choisi
	 * sauvegarde	: Chemin indiquant l'emplacement de sauvegarde du .exo
	 * mode			: Mode choisi, 0 si pas de mode choisi, 1 pour entrainement et 2 pour �valuation
	 * ------------------ Mode ENTRAINEMENT ------------------
	 * affichageMots: Valeur bool�enne de l'option d'affichage du nombre de mots d�couverts
	 * incomplet	: Nombre de lettres autoris�es avec l'option mot incomplet, vaut 0 si l'option n'est pas activ�e, sinon 2 ou 3
	 * solution		: Valeur bool�enne de l'option d'affichage de la solution
	 *  ------------------ Mode  EVALUATION ------------------
	...
	public void fillRecap(String nomExo, String consigne, String script, String aide, String media, char occult, String sauvegarde, String mode, boolean affichageMots, int incomplet, boolean solution, int tempsLimite) {
		 ...
		 *  - Autoriser mot incomplet (oui ou non)
    		- Nombre de lettres autoris�es (2 ou 3)
  			- Autoriser affichage du nombre de mots d�couverts (oui ou non)
	...
	public void createErrorAlert() {
		...
		alert.setHeaderText("La sauvegarde a �chou�e");
	...
	public void createValidationAlert(String pathExo, String nomExo) {
		Alert alert = new Alert(Alert.AlertType.INFORMATION,
				"Vous pouvez retrouver le fichier de l'exercice sur votre ordinateur � cet emplacement : \n"
				+ pathExo+"\\"+nomExo+".exo", ButtonType.OK);

		alert.setHeaderText("Votre fichier a �t� sauvegard� avec succ�s");
